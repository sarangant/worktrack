    ...
    <div className="space-y-6">
      ...
      <Card title="Profiloplysninger">
        <div className="space-y-4">
          ...
          <div>
            <label className="text-sm text-text-muted">Rolle</label>
            <p className="text-text-primary">{auth.user?.role === 'admin' ? 'Administrator' : 'Medarbejder'}</p>
          </div>
          <div>
            <label className="text-sm text-text-muted">Bruger-ID</label>
            <p className="text-text-primary">{auth.user?.id}</p>
          </div>
